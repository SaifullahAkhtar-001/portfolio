            ...
            <div class="flex max-xl:flex-col justify-center items-center max-md:h-fit  gap-10">
                ...
                <div class="flex-auto">
                    ...
                    <div class="text-[1rem] font-extralight space leading-8 mt-8 px-2 opacity-75">
                        I'm passionate about creating innovative solutions and crafting efficient, user-friendly
                        applications.
                        As a Full Stack Developer, I enjoy working with both frontend and backend technologies to bring
                        ideas to
                        life.
                    </div>
                </div>
