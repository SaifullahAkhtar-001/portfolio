<template>
  <div class="text-xl dark:bg-stone-800 m-0 dark:text-white min-h-screen min-w-full">
      ...
      <Aboutme id="about" />
      <Footer />
      <a href="#home" class="transition-all max-xl:duration-1000 duration-100 flex justify-center items-center bg-opacity-90 rounded-full fixed bottom-8 right-4 h-10 w-10 cursor-pointer border-2 border-stone-400 active:border-2 xl:hover:border-2  active:border-green-500 xl:hover:border-green-500">
